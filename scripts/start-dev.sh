...
echo -e "  ${GREEN}cd apps/command-center && npm run dev${NC}  - Start Command Center API"
echo -e "  ${GREEN}cd apps/api-ai && python orchestrator_main.py${NC}  - Start Agent Orchestrator worker"
echo ""
...
echo -e "  Command Ctr:  ${GREEN}http://localhost:4100${NC}"
